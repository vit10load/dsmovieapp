create table tb_movie (id  bigserial not null, count int4, image varchar(255), score varchar(255), title varchar(255), primary key (id));
create table tb_score (valor float8, movie_id int8 not null, user_id int8 not null, primary key (movie_id, user_id));
